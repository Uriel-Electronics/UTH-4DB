        ...
        NavigationStack {
            ZStack {
                if navigateToLanding {
                    LandingView(bluetoothManager: bluetoothManager, navigateToLanding: $navigateToLanding, powerOnOff: bluetoothManager.powerOnOff, mode1_CHT1_Value: bluetoothManager.mode1_CHT1_Value, mode1_CHT2_Value: bluetoothManager.mode1_CHT2_Value, mode1_CHT3_Value: bluetoothManager.mode1_CHT3_Value,mode1_CHT4_Value: bluetoothManager.mode1_CHT4_Value)
                } else {
